...
void main() {
    ...
    const ivec2 page_offset = u_vsm_globals_ptr.data.clipmap_page_offsets[u_view_index];
    const ivec2 virtual_page = ((position / IRIS_VSM_VIRTUAL_PAGE_SIZE) + page_offset) % IRIS_VSM_VIRTUAL_PAGE_ROW_SIZE;
